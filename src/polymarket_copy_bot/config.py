...
class Settings(BaseModel):
    ...
    min_delta_shares: float = Field(default=0.01)
    min_notional_usd: float = Field(default=0.05)
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            min_delta_shares=float(os.getenv("MIN_DELTA_SHARES", "0.01")),
            min_notional_usd=float(os.getenv("MIN_NOTIONAL_USD", "0.05")),
